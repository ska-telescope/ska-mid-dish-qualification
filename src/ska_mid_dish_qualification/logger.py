...
class Logger:
    ...
    def add_nodes(self, nodes: list[str], period: int):
        """
        Add a node or list of nodes with desired period in miliseconds to subscribe to.
    ...
    def stop(self):
        ...
        Ends the addition of new server data to internal queue
    ...
    def _log(self):
        ...
        # Subscriptions have been stopped so clear remaining queue, do a final flush,
        # and close file.
